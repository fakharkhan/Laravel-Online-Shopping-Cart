...
<li>
    <a href="javascript:void(0)"><i class="clip-screen"></i>
        <span class="title"> System Definitions </span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
            <a href="{{ URL::to('vendors') }}">
                <span class="title"><i class="fa fa-group"></i> Vendors </span>
                <span class="badge badge-new">new</span>
            </a>
        </li>
        <li>
            <a href="{{ URL::to('categories') }}">
                <span class="title"><i class="fa fa-group"></i> Categories </span>
            </a>
        </li>
        <li>
